...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 max-w-[450px] mx-auto flex flex-col font-sans relative overflow-hidden text-slate-900 shadow-2xl border-x border-slate-200 antialiased touch-pan-y">
        ...
        <div className="flex-1 flex flex-col overflow-y-auto pb-32 bg-white animate-in fade-in duration-500 scroll-smooth">
          ...
          <div className="p-5 flex-1">
            <div className="bg-gradient-to-br from-[#800000] to-[#4a0404] rounded-[2.5rem] p-8 text-white shadow-2xl mb-8 relative overflow-hidden text-left">
               <h3 className="text-3xl font-black tracking-tighter mb-1 uppercase leading-none">University Panel</h3>
      ...
      {/* ABOUT TAB */}
      {activeTab === 'info' && (
        <div className="flex-1 flex flex-col bg-white overflow-y-auto pb-32 animate-in fade-in duration-500 text-left overscroll-none">
      ...
      {!selectedSem && (
        <div className="fixed bottom-0 max-w-[450px] w-full bg-white/95 backdrop-blur-3xl border-t border-slate-100 px-10 py-6 flex justify-around items-center rounded-t-[3.2rem] shadow-xl z-100 text-center">
          <button onClick={() => {setActiveTab('home'); setSelectedDept(null); setSelectedProgramObj(null);}} className={`flex flex-col items-center gap-2 transition-all ${activeTab === 'home' ? 'text-[#800000] scale-110' : 'text-slate-300'} text-center`}>
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.1em] text-center">PORTAL</span>
          </button>
